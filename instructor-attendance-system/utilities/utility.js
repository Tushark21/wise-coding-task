const { MONTHS, CHECK_OUT, INVALID_MONTH_ERROR, OVERLAPPING_STATUS_ERROR, OVERLAPPING_TIME_ERROR, CHECK_IN, UNKNOWN_STATUS_ERROR,
    INVALID_DATE_ERROR, INVALID_TIME_ERROR, ERROR_OCCURED, INVALID_INSTRUCTOR_ERROR } = require('./constants');
